...
- **`ai-animation`** — turns a finished script + already-made images (character, scene, product) into ready-to-paste **animated** video-ad prompts (Pixar/Disney 3D first). Current model: ByteDance Seedance 2.0 (image-to-video). **Entry point: `skills/ai-animation/SKILL.md`.**
