...
```
dance-pop, 128 BPM, driving four-on-the-floor, high-energy, bright belted female vocals, catchy melodic topline, continuous vocals, vocals start immediately, no instrumental breaks, polished modern mix
```
...
4. You now have 3 songs sharing a consistent body, each continuous hook→body. (Short song — no Extend needed here.)
...
- **Gapless + non-rap** — opens on the hook (no `[Intro]`), no `[Bridge]`/`[Instrumental]`, `[Outro: Cold End]`; BPM + sung genre up front, rap excluded.
