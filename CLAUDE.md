...
For animated (Pixar/Disney 3D) video-ad prompts — including music ones from a finished song (beat-cut music videos via SRT timestamps; sung jingle ads) — the skill lives at `skills/ai-animation/` — start at `skills/ai-animation/SKILL.md` and load only the files it points to.
